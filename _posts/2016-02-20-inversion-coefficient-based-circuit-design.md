...
<a href="http://kevinfronczak.com/documents/2016/02/inversion_coefficient.gif" rel="attachment wp-att-1157"><img class="aligncenter size-full wp-image-1157" src="{{ site.baseurl }}/assets/inversion_coefficient.gif" alt="inversion_coefficient_constant_gm" width="420" height="480" /></a>
In the Fall 2015 edition of "IEEE Solid-State Circuits Magazine", Sansen published the following flowchart, illustrating a design flow using the inversion coefficient where the designer only needs to make two choices: the actual inversion coefficient, and the length of the device [4].  All other parameters will fall out of the equations.<a href="http://kevinfronczak.com/documents/2016/02/design_method.png" rel="attachment wp-att-1159"><img class="aligncenter size-full wp-image-1159" src="{{ site.baseurl }}/assets/design_method.png" alt="sansen_design_method_inversion_coefficient" width="550" height="449" /></a>
...
<a href="http://kevinfronczak.com/documents/2016/02/example_design_results.png" rel="attachment wp-att-1161"><img class="aligncenter  wp-image-1161" src="{{ site.baseurl }}/assets/example_design_results.png" alt="example_design_results" width="653" height="410" /></a>
...
<a href="http://kevinfronczak.com/documents/2016/02/design_optimization_matlab.png" rel="attachment wp-att-1162"><img class="aligncenter  wp-image-1162" src="{{ site.baseurl }}/assets/design_optimization_matlab.png" alt="design_optimization_matlab" width="663" height="452" /></a>
<h2>Conclusion</h2>
