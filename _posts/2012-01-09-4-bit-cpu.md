...
[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/CPU.bmp)]({{ site.baseurl }}{{ site.image_path }}/CPU.bmp) 

[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/CPU_High_Level_Control_Datapath.bmp)]({{ site.baseurl }}{{ site.image_path }}/CompArch/CPU_High_Level_Control_Datapath.bmp)
...
[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/4_bit_register.bmp)]({{ site.baseurl }}{{ site.image_path }}/4_bit_register.bmp)
...
[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/Datapath.bmp)]({{ site.baseurl }}{{ site.image_path }}/Datapath.bmp)
...
[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/Control_Unit.bmp)]({{ site.baseurl }}{{ site.image_path }}/Control_Unit.bmp)
...
[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/Full_ALU.bmp)]({{ site.baseurl }}{{ site.image_path }}/Full_ALU.bmp)
...
[![{{site.baseurl}}]({{ site.baseurl }}{{ site.image_path }}/datapath_waveforms.bmp)]({{ site.baseurl }}{{ site.doc_path }}{{ site.image_path }}/datapath_waveforms.bmp)
